...
export function Pill({ pill, isSelected, onClick, disabled = false }: PillProps) {
  ...
  const getPillStyles = () => {
    const baseStyles = 'flex-shrink-0 px-4 py-1.5 rounded-full text-sm font-medium transition-all duration-200 active:scale-95 min-h-[44px] flex items-center justify-center gap-1.5';
