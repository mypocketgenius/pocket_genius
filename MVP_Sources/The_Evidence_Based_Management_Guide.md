...
Published by Scrum.org. Licensed under Creative Commons Attribution Share-Alike 4.0.
...
Figure 1: The EBM Experiment Loop. The diagram shows a cycle of reaching strategic goals through experimenting, inspecting, and adapting. Organizations move from their Current State through Immediate Tactical Goals and Intermediate Goals toward their Strategic Goal by running experiments, measuring results, and adjusting their approach. This concept is based on the Improvement Kata by Mike Rother.
...
The Experiment Loop (shown in Figure 1) helps organizations move from their Current State toward their Immediate Tactical Goal, their Intermediate Goal, and ultimately their Strategic Goal, by taking small, measured steps, called experiments, using explicit hypotheses. This concept is related to the Plan-Do-Check-Act (PDCA) cycle. This loop consists of:
...
Figure 2: The EBM Key Value Areas (KVA) diagram. It shows four quadrants: Current Value (CV) measures the value delivered today, Unrealized Value (UV) measures potential future value, Ability to Innovate (A2I) measures the effectiveness of delivering new capabilities, and Time-to-Market (T2M) measures how quickly the organization can deliver value and learn from feedback. Together these four KVAs provide lenses to examine improvement opportunities.
...
| Production Incident Count | The number of times in a given period that the Developers were interrupted to fix a problem in an installed product. The number and frequency of Production Incidents can help indicate the stability of the product. |
...
Copyright Scrum.org. Licensed under Creative Commons Attribution Share-Alike 4.0.
